...
import static com.example.android.pets.database.PetContract.PetEntry.GENDER_FEMALE;
import static com.example.android.pets.database.PetContract.PetEntry.GENDER_MALE;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                savePet();
                //go to the previous activity once a pet is saved
                return true;
            ...
            case android.R.id.home:
                ...
                showUnsavedChangesDialog(discardButtonClickListener);
                return true;                // Navigate back to parent activity (CatalogActivity)
    ...
    private void savePet() {
        ...
        String stringPetBreed;
        int petWeight;

        stringPetName = mNameEditText.getText().toString().trim();
        if (TextUtils.isEmpty(stringPetName)) {
            Toast.makeText(this, getString(R.string.enter_name), Toast.LENGTH_SHORT).show();
            return;
        }

        stringPetBreed = mBreedEditText.getText().toString().trim();
        if (TextUtils.isEmpty(stringPetBreed)) {

stringPetBreed=getString(R.string.breed_unknown);
        }

        String stringPetWeight = mWeightEditText.getText().toString();
        if (!TextUtils.isEmpty(stringPetWeight)) {
            petWeight = Integer.parseInt(stringPetWeight);
        } else {
        ...
        values.put(PetEntry.COLUMN_PET_NAME, stringPetName);
        values.put(PetEntry.COLUMN_PET_BREED, stringPetBreed);
